...
const mockHealthTips: HealthTip[] = [
  {
    ...
    title: "Stay Hydrated",
    description:
      "Drink at least 8 glasses of water daily to maintain good health an...",
    fullDescription:
      "Drink at least 8 glasses of water daily to maintain good health and proper body function.",
    category: "Hydration",
  ...
  },
  {
    ...
    description:
      "Engage in at least 30 minutes of physical activity daily to keep yo...",
    fullDescription:
      "Engage in at least 30 minutes of physical activity daily to keep your body healthy and maintain cardiovascular fitness.",
    category: "Exercise",
  ...
  },
  {
    ...
    title: "Balanced Diet",
    description:
      "Include fruits, vegetables, whole grains, and lean proteins in your ...",
    fullDescription:
      "Include fruits, vegetables, whole grains, and lean proteins in your daily meals to ensure proper nutrition and energy levels.",
    category: "Nutrition",
  ...
  },
  {
    ...
    title: "Quality Sleep",
    description:
      "Get 7-9 hours of quality sleep each night to allow your body to ...",
    fullDescription:
      "Get 7-9 hours of quality sleep each night to allow your body to rest, repair, and recharge for optimal health.",
    category: "Sleep",
